...
public class UserController {
    ...
    public ResponseEntity<Page<User>> searchBySalary(@RequestParam(defaultValue = "0") Double minSalary, @RequestParam(defaultValue = "100000000") Double maxSalary, Pageable pageable) {
